...
class Fragment_tpvanhocvietnam : Fragment() {
    ...
    private var txtxemthemvivo: TextView? = null
    override fun onCreateView(
        inflater: LayoutInflater,
        container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        view1 = inflater.inflate(R.layout.fragment_tpvanhocvietnam, container, false)
        anhxa()
        getdatasanpham()
        Onclickxemthem()
        return view1
    ...
    private fun Onclickxemthem() {
        txtxemthemvivo?.setOnClickListener {
    ...
    private fun getdatasanpham() {
        ...
        val callback = dataService.getdatavivo()
    ...
    private fun anhxa() {
        txtxemthemvivo = view1?.findViewById(R.id.txtxemthemvivo)
        arrayList = ArrayList()
