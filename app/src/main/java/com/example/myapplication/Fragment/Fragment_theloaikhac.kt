...
class Fragment_theloaikhac : Fragment() {
    ...
    private var txtxemthemsony: TextView? = null
    override fun onCreateView(
        inflater: LayoutInflater,
        container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        view1 = inflater.inflate(R.layout.fragment_theloaikhac, container, false)
        anhxa()
        getdatasanpham()
        onclickcxemthem()
        return view1
    ...
    private fun onclickcxemthem() {
        txtxemthemsony?.setOnClickListener {
    ...
    private fun getdatasanpham() {
        ...
        val callback = dataService.getdatasony()
    ...
    private fun anhxa() {
        txtxemthemsony = view1?.findViewById(R.id.txtxemthemsony)
        arrayList = ArrayList()
