...
class Fragment_vanhocdangian : Fragment() {
    ...
    private var txtxemthemhuawei: TextView? = null
    override fun onCreateView(
        inflater: LayoutInflater,
        container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        view1 = inflater.inflate(R.layout.fragment_vanhocdangian, container, false)
        anhxa()
        getdatasanpham()
        onclickxemthem()
        return view1
    ...
    private fun onclickxemthem() {
        txtxemthemhuawei?.setOnClickListener {
    ...
    private fun anhxa() {
        txtxemthemhuawei = view1?.findViewById(R.id.txtxemthemhuawei)
        arrayList = ArrayList()
